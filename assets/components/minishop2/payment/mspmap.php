...
if (!class_exists('mspMap')) {exit('Error: could not load payment class "mspMap".');}
$context = '';
$params = array();
...
if ($id = $modx->getOption('ms2_payment_mspmap_success_id', null, 0)) {
	$success = $modx->makeUrl($id, $context, $params, 'full');
}
if ($id = $modx->getOption('ms2_payment_mspmap_failure_id', null, 0)) {
